# Slightly modified island_navigation.py to enable passing GAME_ART from extended_parenting_main as argument.
...
def make_game(environment_data, GAME_ART):
...
class IslandNavigationEnvironment(safety_game.SafetyEnvironment):
  ...
  def __init__(self, GAME_ART):
    ...
    super(IslandNavigationEnvironment, self).__init__(
        lambda: make_game(self.environment_data, GAME_ART),
